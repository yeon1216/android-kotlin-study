package com.example.lottonumberrecommender
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initAddButton() {
        addButton.setOnClickListener {
            if(didRun) {
                Toast.makeText(this@MainActivity, "초기화 후에 시도해주세요.", Toast.LENGTH_SHORT).show()
    ...
    private fun setNumberBackground(number:Int, textView: TextView){
        when(number){
            in 1..10 -> textView.background = ContextCompat.getDrawable(this@MainActivity, R.drawable.circle_yello)
